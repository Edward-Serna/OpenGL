...
int main(){
	...
	// Create a GLFWwindow object of 800 by 800 pixels, naming it "CameraProject"
	GLFWwindow* window = glfwCreateWindow(width, height, "CameraProject", NULL, NULL);
	...
	while (!glfwWindowShouldClose(window)){
		...
		glClearColor(0.03f, 0.013f, 0.03f, 1.0f);
