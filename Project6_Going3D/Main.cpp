...
int main()
{
	...
	//GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, "Going3D Project", monitor[1], NULL);
	GLFWwindow* window = glfwCreateWindow(800, 800, "Going3D Project", NULL, NULL);
