...
int main()
{
	...
	// Create a GLFWwindow object of 800 by 800 pixels, naming it "StencilBuffer&Outline"
	GLFWwindow* window = glfwCreateWindow(width, height, "StencilBuffer&Outline", NULL, NULL);
